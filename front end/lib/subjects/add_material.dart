...
import 'package:Athena/subjects/material_viewer.dart';
...
class _AddMaterialState extends State<AddMaterial> {
        ...
        materialImage = materialImage = new Container(
            ...
            child: new GestureDetector(
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) =>
                  MaterialViewer(network: false, source: image,))),
              child: new Hero(
                  tag: "material"+image,
                  child: FittedBox(
                    fit: BoxFit.cover,
  ...
  void putMaterial() async {
    ...
    Map map = {
      ...
      "fileName": fileName == widget.currentMaterial?.fileName ||  fileName == "" ? "" : fileName,
      "previousFile": widget.currentMaterial == null ? null :
        fileName == widget.currentMaterial.fileName ||  fileName == "" || widget.currentMaterial.fileName == "" ? null :
        widget.currentMaterial.fileName,
    };
