    ...
    return Scaffold(
      ...
      body: new Center(
        child:new Row(
          ...
          children: <Widget>[
            new HomeTile(title: "Timetables",  icon: Icons.insert_invitation, route: VirtualHardback(pageTitle: widget.pageTitle,)),
            new HomeTile(title: "Subject Hub",  icon: Icons.school, route: VirtualHardback(pageTitle: widget.pageTitle,)),
          ],
        ),
      )
    );
