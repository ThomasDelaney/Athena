            ...
            Scaffold(
                ...
                appBar: new AppBar(
                  ...
                  actions: recorder.recording ? <Widget>[
                    ...
                    loaded && fontLoaded && themeColourLoaded && cardColourLoaded && backgroundColourLoaded ? IconButton(
                      icon: Icon(Icons.mic),
                    ...
                    new Container(
                        ...
                        new Stack(
                          ...
                          children: <Widget>[
                            new Container(
                                margin: MediaQuery.of(context).viewInsets,
                                child: new ModalBarrier(color: Colors.black54, dismissible: false,)), recorder.drawRecordingCard(context, fontData, cardColour, themeColour, oldData, backgroundColour)],) : new Container()
                    ),
                  ],
                )
            ),
