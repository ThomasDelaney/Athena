...
class TagFilterDialogJournal extends StatefulWidget {
  ...
  final JournalState parent;

  final Color cardColour;
  final Color backgroundColour;
  final Color themeColour;

  TagFilterDialogJournal({Key key, this.fontData, this.backgroundColour, this.themeColour, this.cardColour, this.parent, this.tagValues, this.currentTag}) : super(key: key);

  @override
  _TagFilterDialogJournalState createState() => _TagFilterDialogJournalState();
}

class _TagFilterDialogJournalState extends State<TagFilterDialogJournal> {
